...
\textbf{Resolução:}
A partir do processo iterativo descrito na Equação~\ref{eq:parte1} é possível achar os pontos fixos $x^{*}$ analisando o processo iterativo:
...
Pela Equação~\ref{equ:pto1} temos o ponto fixo $x^{*} = 0$. Agora quando $x^{*} \neq 0$:
...
Pela Equação~\ref{equ:pto2} temos o ponto fixo $x^{*} = \frac{\lambda - 1}{\lambda}$.
